...
class GruposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create grupo" do
    assert_difference("Grupo.count") do
      post grupos_url, params: { grupo: { criado_por_id: @grupo.criado_por_id, nome: @grupo.nome } }
    end
  ...
  test "should update grupo" do
    patch grupo_url(@grupo), params: { grupo: { criado_por_id: @grupo.criado_por_id, nome: @grupo.nome } }
