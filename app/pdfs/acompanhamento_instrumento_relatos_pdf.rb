class AcompanhamentoInstrumentoRelatosPdf < BasePdf
  ...
  def header
    gerar_cabecalho "#{@acompanhamento.render_info_padrao} - Aplicações de instrumentos"
  end

  def title
    font @heading_font, style: :bold
    text "#{@acompanhamento.render_info_padrao} - Aplicações de instrumentos", size: 36, align: :right
    move_down 36
  end
